...
# python predict.py --image /static/input/dog.jpg --model /static/models/smallvggnet.model --label-bin /static/models/smallvggnet_lb.pickle --width 64 --height 64
...
def predictCNN(pathToFile):
    # construct the argument parser and parse the arguments
    #ap = argparse.ArgumentParser(arguments)
